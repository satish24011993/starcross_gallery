...
class ImageView(GallerySettingsMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # If there is an album in the context, look up the image in it
        if context['apk']:
...
class ImageCreate(GallerySettingsMixin, LoginRequiredMixin, FormView):
    ...
    form_class = 'gallery/image_upload.html'
    template_name = 'gallery/image_upoad.html'
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, "Images added succeessfully")
